        ...
        ">
            ...
            <div className="z-50">
                <Link to={'/words'} className="z-50">
                    ...
                    <DoubleArrowLeftIcon
                        className="inline rounded-full m-1 w-[30px] h-[30px] absolute top-10 z-50"
            ...
            <div className="flex flex-col items-center justify-center sm:text-sm md:text-5xl">
                <p className="text-amber-950 md:text-sm sm:text-sm 
                md:m-4 text-right md:w-[50%] w-[65%] dark:text-amber-500
            ...
            <div className="z-50">
                <Link to={'/words'} className="z-50">
                    <DoubleArrowLeftIcon
                        className="inline rounded-full m-1 w-[30px] h-[30px] absolute bottom-2 right-10"
                        stroke="gray" strokeWidth={0.1}
                    />

                    <DoubleArrowLeftIcon
                        className="inline rounded-full m-1 w-[30px] h-[30px] absolute bottom-8 z-50 right-10"
                        stroke="gray" strokeWidth={1.1}
                    />
